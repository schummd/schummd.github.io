      ...
      <div className="container w-4/5 md:w-3/5 my-28">
        <div className="grid md:gap-x-6 gap-y-1 font-montserrat">
          ...
          <div className="col-span-2 flex flex-col md:flex-row md:gap-5">
            ...
            <a onClick={() => navigate('/experience')} className="pt-2.5 md:py-2.5 font-semibold text-indigo-500">
              Resume
            ...
            <a onClick={() => navigate('/publications')} className="md:py-2.5 font-semibold text-indigo-500">
              Publications
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 inline-block ml-1">
            ...
            <a href="https://scholar.google.com/citations?user=lhm6SNsAAAAJ&hl=en" target="_blank" className="md:py-2.5 font-semibold text-indigo-500">
              Google Scholar
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 inline-block ml-1">
