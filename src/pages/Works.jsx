      ...
      <div className="container w-4/5 md:w-3/5 my-28">
        ...
        <div className="grid md:gap-x-6 gap-y-1 font-montserrat">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="grid col-span-2 md:col-span-1 gap-1">
              <div>
                <a href="https://iteratio.netlify.app" className="font-semibold text-indigo-500" target="_blank">
                  Iteratio
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4 inline-block ml-1">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
                  </svg>
              ...
              <div className="text-slate-500">Javascript, React, Material UI</div>
              <div className="mt-2">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="grid col-span-2 md:col-span-1 gap-1">
              <div>
                <a href="https://dariaschummphoto.netlify.app" className="font-semibold text-indigo-500" target="_blank">
                  Schumm Photography
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4 inline-block ml-1">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
                  </svg>
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="grid col-span-2 md:col-span-1 gap-1">
              <div>
                <a onClick={() => navigate('/')} className="font-semibold text-indigo-500" target="_blank">
                  This website
                </a>
              </div>
              <div className="text-slate-500">Javascript, React, Vite, Tailwindcss</div>
              <div className="mt-2">
                This website is another example of the front-end works that was completed recently.
                The purpose is to work as a resume, showcasing work experience, front-end portfolio,
